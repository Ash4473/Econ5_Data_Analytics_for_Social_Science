...
# Make a scatter plot of height vs blocks using the nba data frame.
plot(__, __, 
     __ = "Height", 
     __ = "Blocks", 
     __ = 16, 
     __ = "Height of NBA Players and Blocks")
...
plot(florida$Perot96, florida$Buchanan00, 
     __ = "Perot's votes in 1996",
     __ = "Buchanan's votes in 2000", 
     __ = "Third Party Vote in Florida, 1996 & 2000",
     __ = 16)
...
plot(face$d.comp, face$diff.share, 
     ...
     __ = c(0,1), 
     __ = c(-1,1),
     __ = "Competence scores for Democrats",
     __ = "Democratic margin in vote share",
     __ = "Facial Competence in Vote Share")
